...
namespace SQLiteAgenda.Vistas
{
    ...
    public partial class V_Detalle : ContentPage
    {
        ...
        public V_Detalle(int id, string nom, string ap, string edad, string dir, string puesto)
        {
            InitializeComponent();
        ...
        {
            var rutaDB = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "AgendaEmpleadosSQLite.db3");
